...
public class RobotoCalendarView extends LinearLayout {
	...
	public static final int RED_LINE = R.drawable.red_line;
	public static final int GREEN_LINE = R.drawable.green_line;
	public static final int BLUE_LINE = R.drawable.blue_line;
