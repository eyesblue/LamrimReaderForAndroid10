...
public class ChangeLog {
    ...
    protected AlertDialog getDialog(boolean full) {
        //WebView wv = new WebView(this.context); // This cause force close after AndroidX package with [implementation 'androidx.appcompat:appcompat:1.1.0']
        WebView wv = new WebView(this.context.getApplicationContext());
